  ...
  },
  {
    ...
    props: [
      ...
      { name: "wrap", type: "boolean", desc: "元素是否换行" },
        { name: "justify", type: "'start' | 'center' | 'end'", desc: '元素在主轴方向上的对齐方式' },
        { name: "align", type: "'start' | 'center' | 'end'", desc: '元素在交叉轴方向上的对齐方式' },
        { name: 'gap', type: 'string', desc: '元素之间的间隙' },
        { name: 'bothCenter', type: 'boolean', desc: '元素是否在主轴和交叉轴方向上都居中显示' },
{name: 'children', type: 'element', desc: 'd'}
    ],
    example: <FlexExample />,
  },
  {
