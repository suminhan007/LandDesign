...
export const IconCheckCircle: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style} className={className}>
            <path d="M36 19L24 31L12 19H36Z" fill={strokeWidth === 0 ? fill : 'none'} stroke={strokeWidth === 0 ? 0 : stroke} strokeWidth={strokeWidth} strokeLinejoin="round" />
            <path d="M24 44C29.5228 44 34.5228 41.7614 38.1421 38.1421C41.7614 34.5228 44 29.5228 44 24C44 18.4772 41.7614 13.4772 38.1421 9.85786C34.5228 6.23858 29.5228 4 24 4C18.4772 4 13.4772 6.23858 9.85786 9.85786C6.23858 13.4772 4 18.4772 4 24C4 29.5228 6.23858 34.5228 9.85786 38.1421C13.4772 41.7614 18.4772 44 24 44Z" fill={strokeWidth === 0 ? fill : 'none'} stroke={strokeWidth === 0 ? 0 : stroke} strokeWidth={strokeWidth} stroke-linejoin="round" />
            <path d="M16 24L22 30L34 18" stroke={strokeWidth ? stroke : 'transparent'} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
<svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" stroke-linecap="butt" stroke-linejoin="miter" class="arco-icon arco-icon-check-circle" style="font-size: 32px;">
    <path d="m15 22 7 7 11.5-11.5M42 24c0 9.941-8.059 18-18 18S6 33.941 6 24 14.059 6 24 6s18 8.059 18 18Z"></path></svg>
