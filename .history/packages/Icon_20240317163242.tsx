...
export const IconCollection: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style} className={className}>
            ...
            <path d="M8.04567 35.9927L4.06738 40.0592L8.04567 44.0001" stroke={stroke} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" /><path d="M38.0427 3.95386L42.021 8.02038L38.0427 11.9612" stroke={fill} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
