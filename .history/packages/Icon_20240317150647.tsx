...
export const IocnArrowRound: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style}>
            ...
            <path d="M24 15V33" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" /><path d="M33 24L24 33L15 24" stroke="#202020" stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
