...
export const IconArrowLine: React.FC<IconProps> = ({
    ...
    <path d="M24 42V6" stroke={fill} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    <path d="M36 30L24 42L12 30" stroke={fill} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const IconArrowDouble: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style}>
            <path d="M31 17L24 24L17 17" stroke={fill} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            <path d="M31 26L24 33L17 26" stroke={fill} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const IconArrow: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style}>
    <path d="M36 18L24 30L12 18" stroke={fill} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
...
export const IconArrowTriangle: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style}>
    <path d="M36 19L24 31L12 19H36Z" fill="none" stroke={fill} strokeWidth={strokeWidth} strokeLinejoin="round" />
        </svg>
    )
}
