...
export const IocnArrowCircleDouble: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style}>
            ...
            <path d="M31 17L24 24L17 17" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M31 26L24 33L17 26" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
