...
export const IconCheck: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style} className={className}>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M4 24L9 19L19 29L39 9L44 14L19 39L4 24Z" fill={fill} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    )
}
