...
export const IconAttentionStroke: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style} className={className}>
            <path d="M24 34.7778V32M24 29V13.2222M47 24C47 36.7024 36.7024 47 24 47C11.2976 47 1 36.7024 1 24C1 11.2976 11.2976 1 24 1C36.7024 1 47 11.2976 47 24Z" stroke={stroke} stroke-width="2"/>
        </svg>
    )
}
