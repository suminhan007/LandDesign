...
export const IconCheck: React.FC<IconProps> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none" style={style} className={className}>
<path fill-rule="evenodd" clip-rule="evenodd" d="M12.4142 25.4142C11.7475 24.7475 11.4142 24.4142 11.4142 24C11.4142 23.5858 11.7475 23.2525 12.4142 22.5858L12.9191 22.0809C13.5858 21.4142 13.9191 21.0809 14.3333 21.0809C14.7475 21.0809 15.0809 21.4142 15.7475 22.0809L19.5858 25.9191C20.2525 26.5858 20.5858 26.9191 21 26.9191C21.4142 26.9191 21.7475 26.5858 22.4142 25.9191L32.9191 15.4142C33.5858 14.7475 33.9191 14.4142 34.3333 14.4142C34.7475 14.4142 35.0809 14.7475 35.7475 15.4142L36.2525 15.9191C36.9191 16.5858 37.2525 16.9191 37.2525 17.3333C37.2525 17.7475 36.9191 18.0809 36.2525 18.7475L22.4142 32.5858C21.7475 33.2525 21.4142 33.5858 21 33.5858C20.5858 33.5858 20.2525 33.2525 19.5858 32.5858L12.4142 25.4142Z" fill="#D9D9D9" style="fill:#D9D9D9;fill:color(display-p3 0.8510 0.8510 0.8510);fill-opacity:1;"/>
        </svg>
    )
}
