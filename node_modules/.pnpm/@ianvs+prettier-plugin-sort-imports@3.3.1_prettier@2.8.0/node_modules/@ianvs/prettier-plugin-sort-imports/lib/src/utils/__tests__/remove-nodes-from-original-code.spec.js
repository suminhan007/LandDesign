...
var code = "\"some directive\";// first comment\n// second comment\nimport z from 'z';\nimport c from 'c';\nimport g from 'g';\nimport t from 't';\nimport k from 'k';\n// import a from 'a';\n  // import a from 'a';\nimport a from 'a';\n";
test('it should remove nodes from the original code', function () {
    ...
    var commentAndImportsToRemoveFromCode = __spreadArray(__spreadArray(__spreadArray([], sortedNodes), allCommentsFromImports), ast.program.directives);
