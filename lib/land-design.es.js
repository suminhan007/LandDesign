...
function or() {
  if (Re)
    return j;
  Re = 1;
  var D = Oe, P = Symbol.for("react.element"), V = Symbol.for("react.fragment"), y = Object.prototype.hasOwnProperty, F = D.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, A = { key: !0, ref: !0, __self: !0, __source: !0 };
  function S(h, l, R) {
    ...
    if (h && h.defaultProps)
      for (v in l = h.defaultProps, l)
        g[v] === void 0 && (g[v] = l[v]);
    return { $$typeof: P, type: h, key: _, ref: I, props: g, _owner: F.current };
  }
...
function ur() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var D = Oe, P = Symbol.for("react.element"), V = Symbol.for("react.portal"), y = Symbol.for("react.fragment"), F = Symbol.for("react.strict_mode"), A = Symbol.for("react.profiler"), S = Symbol.for("react.provider"), h = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), R = Symbol.for("react.suspense"), v = Symbol.for("react.suspense_list"), g = Symbol.for("react.memo"), _ = Symbol.for("react.lazy"), I = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function Pe(e) {
    ...
    function Fe(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === y || e === A || De || e === F || e === R || e === v || ke || e === I || we || xe || je || typeof e == "object" && e !== null && (e.$$typeof === _ || e.$$typeof === g || e.$$typeof === S || e.$$typeof === h || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var m = Object.assign, w = 0, ee, re, te, ne, ae, ie, oe;
    function ue() {
    }
...
var sr = H.exports, lr = function(D) {
  return sr.jsx("div", { children: "land-design LandButton" });
};
export {
  lr as LandButton
};
