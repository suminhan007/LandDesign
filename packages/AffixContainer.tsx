      ...
      >
        ...
        {content && (
          <StyleContainerTag
            ...
            style={{
              left:
                offsetData?.left || placement === "lt" || placement === "lb"
                  ? gap
                  : "auto",
              right:
                offsetData?.right || placement === "rt" || placement === "rb"
                  ? gap
                  : "auto",
              top:
                offsetData?.top || placement === "lt" || placement === "rt"
                  ? gap
                  : "auto",
              bottom:
                offsetData?.bottom || placement === "lb" || placement === "rb"
                  ? gap
                  : "auto",
