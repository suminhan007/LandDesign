      ...
      <div className="flex column gap-12">
        ...
        <div className="flex justify-center gap-24 border p-32">
          <Menu
            data={[
              { key: 1, title: "Navigation 1", clickType: ClickType.SELF },
              { key: 2, title: "Navigation 2", clickType: ClickType.SELF, isNew: true },
              { key: 3, title: "Navigation 3", clickType: ClickType.SELF, isNew: 'Hot' },
              { key: 4, title: "Navigation 4", clickType: ClickType.SELF },
              { key: 5, title: "Navigation 5", clickType: ClickType.SELF },
            ]}
            actived={1}
        ...
        <div className="flex justify-center gap-24 border p-32">
          <Menu
            data={[
              { key: 1, title: "Navigation(cursor)", clickType: ClickType.SELF },
              { key: 2, title: "Navigation(default)", clickType: ClickType.SIMPLE },
              { key: 2, title: "Navigation(not-allowed)", clickType: ClickType.DISABLED },
            ]}
            actived={1}
          />
        </div>
        ...
        <div className="flex justify-center gap-24 border p-32">
          <Menu
            data={[
              { key: 1, title: "Navigation(cursor)", clickType: ClickType.SELF },
              { key: 2, title: "Navigation(default)", clickType: ClickType.SELF },
            ]}
            actived={1}
          />
        </div>
